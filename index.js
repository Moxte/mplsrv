...
console.log('listening on port')}); //8080 //3000
...
io.on('connection', function (socket) {
    ...
    socket.on('player connect', function () {
        ...
        for (var i = 0; i < clients.length; i++) {
            ...
            // in your current game, we need to tell about the other players.
    ...
    socket.on('play', function (data) {
        ...
        //we always send enemies when player joins
    ...
    socket.on('health', function (data) {
        ...
        //only change the health once, we can do this by checkig the originating player
